                ...
                <nav className=' flex   justify-between content-center  px-[16px] py-[18px] md:py-[22px] xl:px-[28px] md:px-[20px] rounded-[10px] bg-[#161D2F] xl:w-[96px] xl:h-[960px] xl:rounded-3xl xl:pt-9  xl:pb-[32px] xl:flex-col xl:justify-normal   '>
                    ...
                    <div className=' flex my-auto  space-x-[24px] xl:space-x-0 xl:mx-auto xl:space-y-[40px] xl:flex-col xl:mt-[74px]'>
                        <NavLink className={({ isActive }) =>
                            `group transition-colors duration-300 ${isActive ? 'text-[#FC4747]' : 'text-[#5A698F]'}`
                        } to={'/'}><svg
                            width="20"
                            height="20"
                            xmlns="http://www.w3.org/2000/svg"
                            className="fill-current group-hover:text-[#FFFFFF] ">
                                <path d="M8 0H1C.4 0 0 .4 0 1v7c0 .6.4 1 1 1h7c.6 0 1-.4 1-1V1c0-.6-.4-1-1-1Zm0 11H1c-.6 0-1 .4-1 1v7c0 .6.4 1 1 1h7c.6 0 1-.4 1-1v-7c0-.6-.4-1-1-1ZM19 0h-7c-.6 0-1 .4-1 1v7c0 .6.4 1 1 1h7c.6 0 1-.4 1-1V1c0-.6-.4-1-1-1Zm0 11h-7c-.6 0-1 .4-1 1v7c0 .6.4 1 1 1h7c.6 0 1-.4 1-1v-7c0-.6-.4-1-1-1Z" /></svg></NavLink>
                        <NavLink className={({ isActive }) =>
                            `group transition-colors duration-300 ${isActive ? 'text-[#FC4747]' : 'text-[#5A698F]'
                            }`
                        } to={'/movies'}><svg
                        ...
                        <NavLink className={({ isActive }) =>
                            `group transition-colors duration-300 ${isActive ? 'text-[#FC4747]' : 'text-[#5A698F]'}`
                        } to={'/tvseries'}><svg width="20"
                            height="20"
                            xmlns="http://www.w3.org/2000/svg"
                            className="fill-current  group-hover:text-[#FFFFFF] transition-colors duration-300"

                        >
                                <path d="M20 4.481H9.08l2.7-3.278L10.22 0 7 3.909 3.78.029 2.22 1.203l2.7 3.278H0V20h20V4.481Zm-8 13.58H2V6.42h10v11.64Zm5-3.88h-2v-1.94h2v1.94Zm0-3.88h-2V8.36h2v1.94Z" /></svg></NavLink>
                        <NavLink className={({ isActive }) =>
                            `group transition-colors duration-300 ${isActive ? 'text-[#FC4747]' : 'text-[#5A698F]'}`
